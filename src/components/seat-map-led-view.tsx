...
export function SeatMapLedView({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className="flex shrink-0 flex-col items-center landscape:w-[42%]"
        ...
        >
          ...
          <div
            className="portrait:w-[min(46vmin,58vw,34vh)] landscape:w-[min(38vmin,34vw,52vh)]"
            style={{
              background: "#ffffff",
          ...
          <p
            ...
            style={{ fontSize: "clamp(11px, 1.7vmin, 30px)", lineHeight: 1.35 }}
          >
            Buka kamera ponsel, arahkan ke kode, lalu ketik nama Anda.
          </p>
        </div>
        ...
        <div className="flex w-full min-w-0 items-center justify-center portrait:max-h-[36vh] landscape:max-h-[74vh] landscape:w-[58%]">
          <SeatMapView
            config={config}
