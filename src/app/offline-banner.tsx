...
export function OfflineBanner() {
  ...
  return <div role="alert" className="fixed inset-x-0 bottom-0 z-50 flex min-h-12 items-center justify-center gap-2 bg-error px-4 text-body-medium font-semibold text-on-error"><WifiSlash size={19} /> OFFLINE — jangan buat order</div>;
}
