...
export default function BoothPage() {
  ...
  async function loadSettings() {
    ...
    if (response.ok) { const data = await response.json(); setPickupMode(data.pickup_mode === "immediate" ? "immediate" : "after_payment"); setCashierRequired(data.cashier_confirmation_required !== false); setTimeZone(normalizeTimeZone(data.time_zone)); }
  }
