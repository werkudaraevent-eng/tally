...
export default function BoothPage() {
  ...
  // Riwayat dilipat secara default di mobile agar aksi utama (SCAN QR) tidak
  // tenggelam oleh daftar panjang. Di layar lebar panel tampil berdampingan.
